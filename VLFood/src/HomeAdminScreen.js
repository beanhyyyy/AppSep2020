...
import HeaderTop from './screen/HeaderTop';
  ...
  render() {
    return (
      <View style={style.container}>
        ...
        <TouchableOpacity onPress={() => this._navigateTo('AddStoresAdmin')}>
          <Text style={[style.btnTextForgot, {color: 'red'}]}>
            Add Stores Admin
          </Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => this._navigateTo('ViewStoresAdmin')}>
